...
export const signOnValidationSchema = Yup.object({
  ...
  repeat_password : Yup.string().min(PASSWORD_LENGTH, PASSWORD_ONE_TWO_NOT_MATCH_ERROR_MSG).oneOf([Yup.ref('password')], PASSWORD_ONE_TWO_NOT_MATCH_ERROR_MSG).required(REQUIRED_PASSWORD_ERROR_MSG)
})
